...
const reviewBodyGenerator = (foodType, restaurantName, reviewStars) => {
  ...
  const reviews = {
    positive: [
      ...
      'I consider myself a foodie and like to think I would have made an excellent restaurant critic if I\'d never gone to Hack Reactor. That said, I can think of nothing negative to say about this place. Everything exceeded my very high expectations. 5 stars.',
      ...
      'This place is an absolute gem! I love coming here because the atmosphere of the place is relaxing and the coffee is great! The staff are INCREDIBELY kind. Always a wonderful experience!',
    ],
    okay: [
      ...
      'I\'ve eaten here a few times before and every time I leave feeling a little disappointing by the food. The ambiance is nice and its at a great location. The service is good, but I think the tables are a little too close to each other. Each time I\'ve been there I have inevitably had to listen to other peoples conversations no matter how much I try to drown them out.',
    ...
    negative: [
      ...
      `I seldom write reviews -- I think it's been years -- but I was so disappointed by my meal last night, and felt so led astray by yelpers, that I felt like I'd make an exception. This is the 3rd time I've been to ${restaurantName}, so I've done my due diligence. The food is just not very good. Twice I had the ${dishOne}, wanting it to be delicious, twice it was flavorless.`,
