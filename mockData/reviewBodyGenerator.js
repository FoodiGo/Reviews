...
const reviewBodyGenerator = (foodType, restaurantName, reviewStars) => {
  ...
  const reviews = {
    ...
    okay: [
      ...
      'I\'ve eaten here a few times before and every time I leave feeling a little disappointed by the food. The ambiance is nice and its at a great location. The service is good, but I think the tables are a little too close to each other. Each time I\'ve been there I have inevitably had to listen to other peoples conversations no matter how much I try to drown them out.',
